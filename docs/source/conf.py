...
# ts2g2_template documentation build
...
from ts2g2_template import __version__ as release

# -- Project information -----------------------------------------------------

project = "ts2g2_template"
author = "Kedro"
...
htmlhelp_basename = "ts2g2_templatedoc"
...
texinfo_documents = [
    (
        ...
        author,
        "ts2g2_template",
        "Project ts2g2_template codebase.",
        "Data-Science",
    )
]
